  ...
  (function langSwitch() {
    const dict = {
      fr: {
        ...
        "nav.home": "Accueil", "nav.explore": "Explorer", "nav.pages": "Pages Dédiées", "nav.profil": "Profil", "nav.impact": "Impact & Métriques", "nav.radar": "Radar d'Expertise", "nav.anatomy": "Anatomie Anophèle", "nav.expertises": "Expertises & Recherche", "nav.entomology": "Entomologie & Calculatrices", "nav.stations": "Stations & BPL", "nav.weather": "Météo & Risque", "nav.genetics": "Génétique & HWE", "nav.llin": "Matrice MILDV", "nav.cost": "Coût-Efficacité", "nav.timeline": "Projets Financés", "nav.audio": "Mini-Capsules Audio", "nav.glp": "Auto-Évaluation BPL", "nav.glossary": "Glossaire Bilingue", "nav.ai": "🔬 Base de Connaissances", "nav.pres": "📽️ Mode Diaporama", "nav.projects": "Projets & Financements", "nav.career": "Parcours & Mentorat", "nav.media": "Médias & Podcasts", "nav.resources": "Ressources & SOPs", "nav.parcours": "Parcours", "nav.formation": "Formation", "nav.service": "Service", "nav.publications": "Publications", "nav.blog": "Blog", "nav.speaking": "Conférences", "nav.distinctions": "Distinctions", "nav.changelog": "Changelog", "nav.contact": "Contact", "action.contact": "Me contacter", "action.back": "← Retour au site", "action.cv": "CV ↓ PDF", "action.meeting": "Prendre rendez-vous", "lang.fr": "FR", "lang.en": "EN",
        "tape.text": "Surveillance entomologique ✦ MILDA · PID · ATSB ✦ Résistance aux insecticides ✦ DHIS2 & données géolocalisées ✦ Essais randomisés de phase III ✦ Plans stratégiques nationaux ✦ OMS · PMI/USAID · Fonds mondial ✦",
        ...
        "search.aria": "Recherche sur le site", "search.placeholder": "Rechercher une page, section, publication, calculatrice...", "search.groupPages": "Pages Dédiées", "search.groupHome": "Sections Accueil", "search.groupPubs": "Publications", "search.groupTalks": "Conférences", "search.groupBlog": "Blog & Notes", "search.groupSkills": "Compétences", "search.groupExpertises": "Expertises", "search.empty": "Aucun résultat trouvé.", "search.nav": "naviguer", "search.open": "ouvrir", "search.close": "fermer",
        "pdf.aria": "Lecteur de document PDF", "pdf.tag": "Visualiseur de Document", "pdf.download": "Télécharger", "pdf.fallbackText": "Le visualiseur intégré ne peut pas afficher directement ce fichier sur votre appareil.", "pdf.fallbackBtn": "Télécharger le fichier PDF directement",
        ...
        "anatomy.eyebrow": "02 — Biologie Vectorielle & Microscopie", "anatomy.title": "<span class=\"ln\"><span>Explorateur anatomique</span></span><span class=\"ln\"><span>de la femelle d'<span class=\"it\">Anopheles gambiae</span></span></span>", "anatomy.lede": "Visualisation interactive des organes vitaux du vecteur : rôles dans le cycle parasitaire du Plasmodium et cibles moléculaires des insecticides.", "anatomy.selectTitle": "Sélectionnez un organe ou tissu :", "anatomy.sciNameLbl": "🔬 Nom scientifique :", "anatomy.roleLbl": "⚙️ Rôle Physiologique :", "anatomy.pathLbl": "🦠 Importance dans la Transmission du Paludisme :", "anatomy.targetLbl": "🛡️ Cible & Impact en Lutte Antivectorielle :",
        "vector.eyebrow": "05 — Entomologie & Résistance", "vector.title": "<span class=\"ln\"><span>Explorateur des vecteurs</span></span><span class=\"ln\"><span>&amp; simulateur de <span class=\"it\">bio-essais OMS</span></span></span>", "vector.lede": "Outils interactifs pour l'identification des espèces anophéliennes et la modélisation standardisée des tests de sensibilité aux insecticides selon les directives de l'OMS.", "vector.tab1": "Fiches d'Identification Vectorielle", "vector.tab2": "Simulateur de Bio-essais (Tubes OMS)", "vector.lblBehavior": "Comportement :", "vector.lblBreeding": "Gîtes larvaires :", "vector.lblResistance": "Mécanismes de résistance :", "vector.simPanelTitle": "Paramètres du Test en Tubes OMS", "vector.simLblInsecticide": "Insecticide diagnostique :", "vector.simLblExposed": "Moustiques testés (N) :", "vector.simLblDead": "Morts à 24h :", "vector.simLblControlN": "Témoins exposés :", "vector.simLblControlDead": "Témoins morts :", "vector.simBtnCalc": "Recalculer le Diagnostic", "vector.simTagInterp": "Interprétation OMS Standard", "vector.simLblRawMort": "Mortalité Brute", "vector.simLblCtrlMort": "Mortalité Témoin", "vector.simLblFinalMort": "Mortalité Corrigée (Abbott)", "vector.simLblRecomm": "Recommandation Opérationnelle :",
        "stations.eyebrow": "05 — Écologie de Terrain & Sites Expérimentaux", "stations.title": "<span class=\"ln\"><span>Stations de recherche</span></span><span class=\"ln\"><span>&amp; sites sentinelles au <span class=\"it\">Bénin</span></span></span>", "stations.lede": "Réseau national de stations de cases expérimentales, insectariums et sites de surveillance entomologique coordonnés pour évaluer les outils de lutte antivectorielle.", "stations.selectTitle": "Sélectionnez une station de recherche :", "stations.lblEco": "🌿 Contexte écoclimatique :", "stations.lblVec": "🦟 Espèces vectorielles prédominantes :", "stations.lblRes": "🧬 Profil de résistance documenté :", "stations.lblExp": "🔬 Essais & Programmes majeurs :",
        "climate.eyebrow": "04 — Éco-Épidémiologie & Météo", "climate.title": "<span class=\"ln\"><span>Tableau de bord météo-entomologique</span></span><span class=\"ln\"><span>&amp; indice de <span class=\"it\">transmission au Bénin</span></span></span>", "climate.lede": "Modélisation en direct de l'Indice d'Émergence Larvaire (Larval Suitability Index) à partir des paramètres thermo-hydrométriques des grandes zones épidémiologiques du Bénin.", "climate.lblTemp": "Température Moyenne", "climate.subTemp": "Optimum anophélien : 26-30°C", "climate.lblHum": "Humidité Relative", "climate.subHum": "Survie adulte prolongée >70%", "climate.lblRain": "Pluviométrie Mensuelle", "climate.subRain": "Création active de gîtes", "climate.lblSuit": "Indice d'Émergence Larvaire", "climate.subSuit": "Favorabilité bioclimatique", "climate.lblSeason": "📅 Contexte Saisonnier :", "climate.lblBreeding": "💧 Typologie des Gîtes Larvaires :", "climate.lblAdvice": "🛡️ Recommandation Stratégique OMS / PNLP :",
        "genetics.eyebrow": "06 — Génétique des Populations & Marqueurs", "genetics.title": "<span class=\"ln\"><span>Calculateur de fréquences alléliques</span></span><span class=\"ln\"><span>&amp; équilibre de <span class=\"it\">Hardy-Weinberg</span></span></span>", "genetics.lede": "Outil interactif de génétique des populations pour analyser la dynamique des marqueurs de résistance <em>kdr</em> (L1014F/S) et <em>ace-1</em> (G119S) chez les anophèles.", "genetics.formTitle": "Paramètres de l'Échantillon Entomologique", "genetics.lblMarker": "Marqueur génétique cible :", "genetics.lblSS": "Sensibles Homocygotes (SS) :", "genetics.hintSS": "Phénotype Sensible", "genetics.lblRS": "Hétérozygotes (RS) :", "genetics.hintRS": "Porteurs de l'allèle R", "genetics.lblRR": "Résistants Homocygotes (RR) :", "genetics.hintRR": "Résistance Forte", "genetics.lblSel": "Coefficient de sélection estimé (s) sous MILDV :", "genetics.btnCalc": "Analyser l'Échantillon", "genetics.tagStats": "Statistiques de Fréquences", "genetics.lblN": "Effectif Total (N)", "genetics.lblFreqP": "Fréquence Allèle S (p)", "genetics.lblFreqQ": "Fréquence Allèle R (q)", "genetics.thGeno": "Génotype", "genetics.thObs": "Observé (O)", "genetics.thExp": "Attendu HWE (E)", "genetics.thChi": "χ² partiel", "genetics.lblDiag": "Diagnostic Génétique :",
        ...
        "samplesize.lblPerTube": "Moustiques par tube OMS standard :", "samplesize.btnCalc": "Calculer la Taille d'Échantillon", "samplesize.tagRecomm": "Dimensionnement Recommandé", "samplesize.lblReq": "Effectif Requis / Groupe (n)", "samplesize.subReq": "Moustiques par bras", "samplesize.lblTot": "Effectif Total (2n)", "samplesize.subTot": "Pour les 2 groupes", "samplesize.lblTubes": "Tubes OMS Recommandés", "samplesize.lblFormula": "📐 Formule biométrique de Fleiss avec correction de continuité :", "samplesize.lblPlan": "Planification Opérationnelle :",
        "llin.eyebrow": "04 — Outils de Prévention & MILDV", "llin.title": "<span class=\"ln\"><span>Matrice comparative des</span></span><span class=\"ln\"><span>moustiquaires de <span class=\"it\">nouvelle génération</span></span></span>", "llin.lede": "Analyse comparative des moustiquaires imprégnées à longue durée d'action (MILDV / LLINs) : modes d'action, efficacité contre les anophèles multirésistants et statut OMS.", "llin.tabAll": "Toutes les technologies", "llin.tabStd": "Standards", "llin.tabPbo": "PBO Synergistes", "llin.tabG2": "Interceptor G2 (Chlorfénapyr)", "llin.tabRg": "Royal Guard (Pyriproxyfène)", "llin.lblMode": "🔬 Mode d'action :", "llin.lblTarget": "🎯 Cible de résistance :", "llin.lblBenin": "🌍 Contexte & Déploiement au Bénin :", "llin.lblEff": "Efficacité terrain", "llin.lblDur": "Durabilité",
        "cost.eyebrow": "12 — Économie de la Santé & Décision", "cost.title": "<span class=\"ln\"><span>Simulateur de coût-efficacité</span></span><span class=\"ln\"><span>des stratégies de <span class=\"it\">lutte antivectorielle</span></span></span>", "cost.lede": "Outil médico-économique pour estimer le coût unitaire par habitant protégé et le coût par cas de paludisme évité selon la technologie antivectorielle déployée en zone de résistance.", "cost.formTitle": "Paramètres du District Sanitaire", "cost.lblPop": "Population cible du district :", "cost.hintPop": "Ex: 150 000 habitants", "cost.lblInc": "Incidence annuelle de base du paludisme :", "cost.hintInc": "Cas pour 1000 habitants/an", "cost.lblIntervention": "Stratégie antivectorielle évaluée :", "cost.lblCov": "Taux de couverture effective de la population :", "cost.covCovered": "de la population couverte", "cost.btnCalc": "Calculer le Bilan Médico-Économique", "cost.tagReport": "Bilan Économique & Impact Sanitaire", "cost.lblBudget": "Budget Annuel Estimé", "cost.subBudget": "Investissement total", "cost.lblCases": "Cas de Paludisme Évités", "cost.subCases": "Cas cliniques prévenus / an", "cost.lblCostCase": "Coût / Cas Évité", "cost.subCostCase": "Ratio coût-efficacité", "cost.lblSynth": "Synthèse d'Aide à la Décision :",
        "glp.eyebrow": "13 — Qualité & Bonnes Pratiques de Laboratoire", "glp.title": "<span class=\"ln\"><span>Auto-évaluation BPL / GLP</span></span><span class=\"ln\"><span>des insectariums &amp; <span class=\"it\">stations d'essais</span></span></span>", "glp.lede": "Grille d'audit interactif basée sur les directives OMS et OECD pour vérifier la conformité opérationnelle des insectariums et des protocoles de bio-essais.", "glp.checklistTitle": "Critères de Conformité OMS (10 Piliers)", "glp.tagScore": "Score d'Audit BPL", "glp.critValidated": "critères validés", "glp.lblDiag": "Diagnostic Opérationnel :",
        "audio.eyebrow": "14 — Micro-Learning & Pédagogie Audio", "audio.title": "<span class=\"ln\"><span>Mini-capsules audio</span></span><span class=\"ln\"><span>« 3 Minutes d'<span class=\"it\">Entomologie Médicale</span> »</span></span>", "audio.lede": "Format audio court pour réviser rapidement les concepts fondamentaux de la lutte antivectorielle, écouter les explications du Dr Ahogni et lire les transcriptions intégrales.", "audio.playlistTitle": "Épisodes Disponibles (Série Pédagogique)", "audio.byDr": "Par Dr Idelphonse Ahogni, PhD", "audio.btnPlay": "▶ Écouter l'extrait", "audio.transcriptTitle": "📝 Transcription intégrale du cours :",
        "glossary.eyebrow": "09 — Terminologie & Pédagogie", "glossary.title": "<span class=\"ln\"><span>Glossaire bilingue</span></span><span class=\"ln\"><span>d'entomologie médicale &amp; <span class=\"it\">santé publique</span></span></span>", "glossary.lede": "Définitions scientifiques et opérationnelles des concepts clés de la lutte antivectorielle, de la résistance aux insecticides et de l'épidémiologie du paludisme.", "glossary.searchPlaceholder": "Rechercher un terme, sigle (ex: TIE, kdr, PBO, bio-essai)...", "glossary.empty": "Aucun terme scientifique ne correspond à votre recherche.",
        "ai.eyebrow": "08 — Base de Connaissances & Recherche Scientifique", "ai.floatLabel": "Base Scientifique", "ai.widgetTitle": "Dr Ahogni · Base de Connaissances", "ai.widgetStatus": "● Moteur Sémantique Certifié · 0 ms · 100% Vérifié", "ai.title": "<span class=\"ln\"><span>Moteur de recherche &amp;</span></span><span class=\"ln\"><span>base de connaissances <span class=\"it\">scientifiques</span></span></span>", "ai.lede": "Interrogez directement la base de connaissances du Dr Ahogni sur les protocoles OMS, les résultats des essais de terrain, les mécanismes génétiques de résistance et les stratégies antivectorielles.", "ai.welcomeMsg": "<p><strong>Bienvenue sur la Base de Connaissances du Dr Idelphonse Ahogni.</strong></p><p style=\"margin-top:6px;font-size:0.88rem;color:var(--ink2);\">Recherche sémantique instantanée sur 25+ publications, protocoles OMS, génétique des vecteurs (<em>kdr/ace-1</em>), moustiquaires MILDV, données de terrain et outils médico-économiques.</p>", "ai.quickLabel": "Questions fréquentes & Suggestions :", "ai.inputPlaceholder": "Ex: Interceptor G2, Abbott, kdr, Covè, Fleiss, BPL...", "ai.btnSubmit": "Rechercher →",
        "mentorship.eyebrow": "10 — Transmission & Nouvelle Génération", "mentorship.title": "<span class=\"ln\"><span>Encadrement académique</span></span><span class=\"ln\"><span>&amp; réseau des <span class=\"it\">chercheurs formés</span></span></span>", "mentorship.lede": "Formation par la recherche, co-direction de thèses de doctorat et mémoires de master en entomologie médicale et santé publique.", "mentor.lblTopic": "Thème de recherche :", "mentor.lblCurrent": "Poste & Devenir actuel :",
        "timeline.eyebrow": "04 — Financements & Recherche Opérationnelle", "timeline.title": "<span class=\"ln\"><span>Programmes de recherche</span></span><span class=\"ln\"><span>&amp; projets <span class=\"it\">financés</span></span></span>", "timeline.lede": "Projets de recherche translationnelle et d'évaluation opérationnelle conduits avec les agences de financement internationales et les ministères de la santé.", "timeline.filterAll": "Tous les programmes", "timeline.lblRole": "Rôle :", "timeline.lblDeliv": "Livrables & Impacts clés :",
        "malariawatch.eyebrow": "08 — Veille Épidémiologique & Alertes", "malariawatch.title": "<span class=\"ln\"><span>Bulletins de transmission</span></span><span class=\"ln\"><span>&amp; veille <span class=\"it\">entomologique</span></span></span>", "malariawatch.lede": "Synthèses régulières sur la dynamique spatiotemporelle de la transmission du paludisme, les alertes vectorielles régionales et les recommandations opérationnelles de santé publique.", "malariawatch.lblAction": "Points d'Action & Recommandations :",
        ...
        "academic.eyebrow": "07 — Ressources & Pédagogie", "academic.title": "<span class=\"ln\"><span>Centre de ressources</span></span><span class=\"ln\"><span>&amp; protocoles de <span class=\"it\">laboratoire</span></span></span>", "academic.lede": "Protocoles opératoires standardisés (SOPs), guides méthodologiques et supports pédagogiques mis à disposition des étudiants, chercheurs et techniciens de santé.", "academic.filterAll": "Tous les documents", "academic.filterProto": "Protocoles", "academic.filterCourse": "Supports de cours", "academic.filterGuide": "Guides de terrain", "academic.filterSheet": "Fiches techniques", "academic.consult": "Consulter", "academic.download": "Télécharger",
        "speaker.eyebrow": "Engagement Académique & Conférences", "speaker.title": "<span class=\"ln\"><span>Inviter à une conférence</span></span><span class=\"ln\"><span>ou <span class=\"it\">solliciter une expertise</span></span></span>", "speaker.lede": "Formulaire guidé pour les comités d'organisation, universités, agences de santé publique et consortiums internationaux.", "speaker.step1": "Format", "speaker.step2": "Thématique", "speaker.step3": "Logistique", "speaker.step4": "Validation", "speaker.titleStep1": "Quel type d'intervention souhaitez-vous organiser ?", "speaker.fmt1Title": "Keynote / Conférence Plénière", "speaker.fmt1Desc": "Intervention magistrale lors de congrès scientifiques ou colloques internationaux (30-45 min).", "speaker.fmt2Title": "Panel / Table Ronde", "speaker.fmt2Desc": "Débat d'experts sur les politiques de santé publique et la lutte antivectorielle.", "speaker.fmt3Title": "Atelier / Masterclass", "speaker.fmt3Desc": "Formation pratique aux protocoles de bio-essais et à la surveillance entomologique (demi-journée ou journée).", "speaker.fmt4Title": "Consulting & Évaluation", "speaker.fmt4Desc": "Mission d'évaluation de programmes, audit entomologique ou revue de propositions de recherche.", "speaker.btnNext": "Continuer →", "speaker.btnPrev": "← Précédent", "speaker.titleStep2": "Sélectionnez les axes thématiques cibles :", "speaker.top1Title": "Résistance aux insecticides & MILDV", "speaker.top1Desc": "Évolution des allèles kdr/ace-1 et impact sur les outils de prévention.", "speaker.top2Title": "Surveillance Génomique", "speaker.top2Desc": "Séquençage haut débit, phylogéographie et traçage des flux de gènes de résistance.", "speaker.top3Title": "Cases Expérimentales & Essais de Phase II", "speaker.top3Desc": "Protocoles d'évaluation en conditions semi-naturelles selon les normes OMS.", "speaker.top4Title": "Vecteurs Émergents (An. stephensi)", "speaker.top4Desc": "Menaces urbaines, diagnostics moléculaires et systèmes d'alerte précoce.", "speaker.lblCustomTopic": "Autre thématique ou titre précis de la session :", "speaker.phCustomTopic": "Ex: Rôle des jeunes chercheurs dans l'élimination du paludisme d'ici 2030", "speaker.titleStep3": "Détails logistiques de l'événement :", "speaker.lblEventDate": "Date ou période envisagée :", "speaker.phEventDate": "Ex: Novembre 2026 / 15-18 Mars 2027", "speaker.lblEventLocation": "Lieu / Ville (ou En ligne) :", "speaker.phEventLocation": "Ex: Cotonou, Genève, Londres ou Visioconférence", "speaker.lblAudienceSize": "Taille et profil de l'audience :", "speaker.lblEventLang": "Langue d'intervention :", "speaker.btnSummary": "Récapitulatif →", "speaker.titleStep4": "Vos coordonnées pour la confirmation :", "speaker.lblOrgName": "Votre nom et prénom :", "speaker.phOrgName": "Dr / Pr ...", "speaker.lblOrgEmail": "Adresse e-mail professionnelle :", "speaker.phOrgEmail": "contact@institution.org", "speaker.lblOrgEntity": "Organisation / Université / Institution organisatrice :", "speaker.phOrgEntity": "Ex: Société de Pathologie Exotique, OMS AFRO, PAMCA...", "speaker.summaryTitle": "📋 Synthèse de votre demande :", "speaker.btnEdit": "← Modifier", "speaker.btnSend": "🚀 Envoyer la Demande Officielle", "speaker.successTitle": "Demande d'intervention préparée avec succès !", "speaker.successDesc": "Un message préformaté avec l'ensemble des détails logistiques et thématiques a été généré. Vous pouvez également réserver directement un échange exploratoire de 20 minutes sur l'agenda :", "speaker.btnAgenda": "📅 Planifier un échange direct", "speaker.btnMail": "✉️ Envoyer par e-mail",
        "pubs.eyebrow": "05 — Publications", "pubs.title": "<span class=\"ln\"><span>Toutes les publications,</span></span><span class=\"ln\"><span><span class=\"it\">évaluées par les pairs</span></span></span>", "pubs.intro": "Plus de 25 publications dans les revues internationales les plus prestigieuses du domaine — Malaria Journal, Parasites & Vectors, Acta Tropica, PLOS ONE, et autres. Liste complète organisée par année, avec filtres, recherche et outils de citation.", "pubs.searchPlaceholder": "Rechercher par titre, auteur, revue, année...", "pubs.expBib": "Exporter tout (.bib)", "pubs.expRis": "Exporter tout (.ris)", "pubs.filterAll": "Toutes", "pubs.viewPdf": "Consulter PDF 👁", "pubs.cite": "Citer / Citation ▾", "pubs.prev": "← Préc", "pubs.next": "Suiv →", "pubs.empty": "Aucune publication ne correspond à votre recherche.", "pubs.profiles": "Profils scientifiques complets :", "pubs.modalTitle": "Citer cette publication", "pubs.copyBtn": "Copier la citation",
        "cv.eyebrow": "07 — Curriculum Vitæ", "cv.title": "<span class=\"ln\"><span>Parcours complet,</span></span><span class=\"ln\"><span><span class=\"it\">formation &amp; expertise</span></span></span>", "cv.intro": "Gestionnaire de programme paludisme, entomologiste médical — formations, parcours professionnel, compétences et publications sélectionnées.", "cv.modeFull": "Vue Détaillée", "cv.modeSummary": "Executive Summary (1-Page)", "cv.btnPdf": "⬇ Télécharger PDF", "cv.docEyebrow": "Curriculum Vitæ · République du Bénin", "cv.secHighlights": "Faits saillants & Impact", "cv.stat1": "Ans d'expérience terrain", "cv.stat2": "Publications internationales", "cv.stat3": "Pays d'intervention en Afrique", "cv.stat4": "Essais cliniques & moustiquaires", "cv.sec01": "Profil & Synthèse professionnelle", "cv.sec02": "Expertises clés", "cv.sec03": "Parcours professionnel", "cv.sec04": "Formation & Diplômes", "cv.sec05": "Compétences techniques & Méthodes", "cv.sec06": "Publications sélectionnées",
        "speaking.eyebrow": "Communications", "speaking.title": "<span class=\"ln\"><span>Conférences &amp;</span></span><span class=\"ln\"><span><span class=\"it\">présentations</span></span></span>", "speaking.intro": "Interventions scientifiques, communications lors de congrès et colloques internationaux sur la lutte antivectorielle et la santé publique.", "speaking.filterAll": "Toutes", "speaking.empty": "Aucune communication ne correspond au filtre sélectionné.",
        "blog.eyebrow": "10 — Blog · Notes de terrain", "blog.title": "<span class=\"ln\"><span>Notes de</span></span><span class=\"ln\"><span><span class=\"it\">terrain</span> &amp; réflexions</span></span>", "blog.intro": "Chroniques de terrain, enseignement et actualités de la lutte antivectorielle et de la recherche sur le paludisme.", "blog.filterAll": "Tous", "blog.readNote": "Lire la note →", "blog.empty": "Aucune note publiée pour le moment. Revenez bientôt.", "blog.backAll": "← Toutes les notes de terrain", "blog.tocTitle": "Sommaire de la note", "blog.otherNotes": "Autres notes de terrain", "blog.shareLabel": "Partager cet article :",
        "contact.eyebrow": "Contacter le Dr Idelphonse B. AHOGNI", "contact.title": "<span class=\"ln\"><span>Travaillons <span class=\"it\">ensemble</span> contre</span></span><span class=\"ln\"><span>le paludisme.</span></span>", "contact.avail": "<span class=\"dot\"></span> Disponible — réponse sous 48 h ouvrées", "contact.formTitle": "Envoyer un message", "contact.formSub": "Les champs marqués <b style=\"color:var(--coral)\">*</b> sont obligatoires. Votre message sera envoyé de façon sécurisée et vous recevrez une réponse sous 48 h ouvrées.", "contact.lblName": "Nom complet", "contact.phName": "Dr Awa Diallo", "contact.errName": "Veuillez saisir votre nom.", "contact.lblEmail": "Adresse e-mail", "contact.phEmail": "vous@organisation.org", "contact.errEmail": "Adresse e-mail invalide.", "contact.lblOrg": "Organisation", "contact.phOrg": "Ministère, ONG, université…", "contact.lblSubject": "Objet de la demande", "contact.lblMsg": "Message", "contact.phMsg": "Décrivez votre demande : contexte, échéances, pays concernés…", "contact.errMsg": "Merci de détailler votre message (20 caractères min.).", "contact.btnSend": "Envoyer le message ↗", "contact.kCard": "Carte de visite numérique", "contact.btnVcf": "Enregistrer contact (.vcf)", "contact.vcfSub": "Compatible iPhone, Android, Outlook & Carnet d'adresses", "contact.kEmail": "E-mail", "contact.emailSub": "Canal privilégié — pièces jointes bienvenues", "contact.kPhone": "Téléphone / WhatsApp", "contact.phoneSub": "Lun – Ven · 8 h – 18 h GMT+1", "contact.kClock": "Heure locale à Cotonou", "contact.kLang": "Langues & réseaux", "contact.vLang": "Français & Fon (natifs) · Anglais (scientifique)", "contact.faqTitle": "Questions fréquentes", "contact.qrDesc": "Scannez ce code avec l'appareil photo de votre smartphone pour enregistrer directement le <b>Dr Idelphonse AHOGNI</b> dans vos contacts.", "contact.qrDl": "Télécharger .vcf direct",
        "pres.exit": "← Quitter le Diaporama", "pres.fullscreen": "⛶ Plein écran", "pres.prev": "← Précédente", "pres.next": "Suivante →",
      ...
      en: {
        ...
        "nav.home": "Home", "nav.explore": "Explore", "nav.pages": "Dedicated Pages", "nav.profil": "Profile", "nav.impact": "Impact & Metrics", "nav.radar": "Expertise Radar", "nav.anatomy": "Anopheles Anatomy", "nav.expertises": "Expertise & Research", "nav.entomology": "Entomology & Tools", "nav.stations": "Field Stations & GLP", "nav.weather": "Climate & Risk", "nav.genetics": "Genetics & HWE", "nav.llin": "LLIN Matrix", "nav.cost": "Cost-Effectiveness", "nav.timeline": "Funded Projects", "nav.audio": "Audio Micro-Capsules", "nav.glp": "GLP Self-Audit", "nav.glossary": "Bilingual Glossary", "nav.ai": "🔬 Knowledge Base", "nav.pres": "📽️ Slide Deck Mode", "nav.projects": "Projects & Grants", "nav.career": "Career & Mentorship", "nav.media": "Media & Podcasts", "nav.resources": "Resources & SOPs", "nav.parcours": "Career", "nav.formation": "Education", "nav.service": "Service", "nav.publications": "Publications", "nav.blog": "Blog", "nav.speaking": "Speaking", "nav.distinctions": "Awards", "nav.changelog": "Changelog", "nav.contact": "Contact", "action.contact": "Contact me", "action.back": "← Back to site", "action.cv": "CV ↓ PDF", "action.meeting": "Book a Meeting", "lang.fr": "FR", "lang.en": "EN",
        "tape.text": "Entomological surveillance ✦ LLINs · IRS · ATSB ✦ Insecticide resistance ✦ DHIS2 & GIS mapping ✦ Phase III randomized trials ✦ National strategic plans ✦ WHO · PMI/USAID · Global Fund ✦",
        ...
        "search.aria": "Site search", "search.placeholder": "Search page, section, publication, calculator...", "search.groupPages": "Dedicated Pages", "search.groupHome": "Home Sections", "search.groupPubs": "Publications", "search.groupTalks": "Conferences & Talks", "search.groupBlog": "Blog & Field Notes", "search.groupSkills": "Skills", "search.groupExpertises": "Expertise", "search.empty": "No results found.", "search.nav": "navigate", "search.open": "open", "search.close": "close",
        "pdf.aria": "PDF document viewer", "pdf.tag": "Document Viewer", "pdf.download": "Download", "pdf.fallbackText": "The built-in viewer cannot display this file directly on your device.", "pdf.fallbackBtn": "Download PDF file directly",
        ...
        "anatomy.eyebrow": "02 — Vector Biology & Microscopy", "anatomy.title": "<span class=\"ln\"><span>Anatomical explorer</span></span><span class=\"ln\"><span>of female <span class=\"it\">Anopheles gambiae</span></span></span>", "anatomy.lede": "Interactive visualization of vital vector organs: roles in the Plasmodium life cycle and insecticide molecular targets.", "anatomy.selectTitle": "Select an organ or tissue:", "anatomy.sciNameLbl": "🔬 Scientific name:", "anatomy.roleLbl": "⚙️ Physiological Role:", "anatomy.pathLbl": "🦠 Role in Malaria Transmission:", "anatomy.targetLbl": "🛡️ Target & Vector Control Impact:",
        "vector.eyebrow": "05 — Entomology & Resistance", "vector.title": "<span class=\"ln\"><span>Vector explorer</span></span><span class=\"ln\"><span>&amp; WHO <span class=\"it\">bioassay simulator</span></span></span>", "vector.lede": "Interactive tools for Anopheles species identification and standardized modeling of insecticide susceptibility bioassays following WHO guidelines.", "vector.tab1": "Vector Identification Sheets", "vector.tab2": "Bioassay Simulator (WHO Tubes)", "vector.lblBehavior": "Biting behavior:", "vector.lblBreeding": "Larval habitats:", "vector.lblResistance": "Resistance mechanisms:", "vector.simPanelTitle": "WHO Tube Test Parameters", "vector.simLblInsecticide": "Diagnostic insecticide:", "vector.simLblExposed": "Mosquitoes tested (N):", "vector.simLblDead": "Dead at 24h:", "vector.simLblControlN": "Controls exposed:", "vector.simLblControlDead": "Control dead:", "vector.simBtnCalc": "Recalculate Diagnosis", "vector.simTagInterp": "Standard WHO Interpretation", "vector.simLblRawMort": "Raw Mortality", "vector.simLblCtrlMort": "Control Mortality", "vector.simLblFinalMort": "Corrected Mortality (Abbott)", "vector.simLblRecomm": "Operational Recommendation:",
        "stations.eyebrow": "05 — Field Ecology & Experimental Sites", "stations.title": "<span class=\"ln\"><span>Research stations</span></span><span class=\"ln\"><span>&amp; sentinel sites in <span class=\"it\">Benin</span></span></span>", "stations.lede": "National network of experimental hut stations, insectaries and entomological surveillance sites coordinated to evaluate vector control tools.", "stations.selectTitle": "Select a research station:", "stations.lblEco": "🌿 Eco-climatic context:", "stations.lblVec": "🦟 Predominant vector species:", "stations.lblRes": "🧬 Documented resistance profile:", "stations.lblExp": "🔬 Major trials & programs:",
        "climate.eyebrow": "04 — Eco-Epidemiology & Climate", "climate.title": "<span class=\"ln\"><span>Meteo-entomological dashboard</span></span><span class=\"ln\"><span>&amp; transmission <span class=\"it\">index in Benin</span></span></span>", "climate.lede": "Live monitoring of thermo-hygrometric factors and Larval Suitability Index modeling across 4 Benin ecoregions.", "climate.lblTemp": "Mean Temperature", "climate.subTemp": "Anopheles optimum: 26-30°C", "climate.lblHum": "Relative Humidity", "climate.subHum": "Prolonged adult survival >70%", "climate.lblRain": "Monthly Rainfall", "climate.subRain": "Active breeding site creation", "climate.lblSuit": "Larval Suitability Index", "climate.subSuit": "Bioclimatic suitability", "climate.lblSeason": "📅 Seasonal Context:", "climate.lblBreeding": "💧 Larval Habitats Typology:", "climate.lblAdvice": "🛡️ WHO / NMCP Strategic Advice:",
        "genetics.eyebrow": "10 — Population Genetics & Modeling", "genetics.title": "<span class=\"ln\"><span>Resistance allele dynamics</span></span><span class=\"ln\"><span>&amp; Hardy-Weinberg <span class=\"it\">equilibrium</span></span></span>", "genetics.lede": "Interactive tool to calculate allelic and genotypic frequencies, test for Hardy-Weinberg equilibrium (HWE), and simulate selection coefficients under vector control pressure.", "genetics.formTitle": "Observed Genotype Counts", "genetics.lblMarker": "Target genetic marker:", "genetics.lblSS": "Homozygous Susceptible (SS):", "genetics.hintSS": "Susceptible Phenotype", "genetics.lblRS": "Heterozygous (RS):", "genetics.hintRS": "R Allele Carriers", "genetics.lblRR": "Homozygous Resistant (RR):", "genetics.hintRR": "Strong Resistance", "genetics.lblSel": "Estimated selection coefficient (s) under LLINs:", "genetics.btnCalc": "Analyze Sample", "genetics.tagStats": "Frequency Statistics", "genetics.lblN": "Total Sample (N)", "genetics.lblFreqP": "S Allele Frequency (p)", "genetics.lblFreqQ": "R Allele Frequency (q)", "genetics.thGeno": "Genotype", "genetics.thObs": "Observed (O)", "genetics.thExp": "Expected HWE (E)", "genetics.thChi": "Partial χ²", "genetics.lblDiag": "Genetic Diagnosis:",
        "size.eyebrow": "11 — Statistical Protocols & Power", "size.title": "<span class=\"ln\"><span>Sample size calculator</span></span><span class=\"ln\"><span>for WHO bioassays &amp; <span class=\"it\">experimental huts</span></span></span>", "size.lede": "Determine the required number of mosquitoes or experimental hut nights needed to detect significant differences in vector mortality or deterrence rates.", "size.formTitle": "Study & Power Parameters",
        "samplesize.lblPerTube": "Mosquitoes per standard WHO tube:", "samplesize.btnCalc": "Calculate Sample Size", "samplesize.tagRecomm": "Recommended Sample Sizing", "samplesize.lblReq": "Required Sample / Arm (n)", "samplesize.subReq": "Mosquitoes per arm", "samplesize.lblTot": "Total Sample (2n)", "samplesize.subTot": "For both study arms", "samplesize.lblTubes": "Recommended WHO Tubes", "samplesize.lblFormula": "📐 Fleiss biometric formula with continuity correction:", "samplesize.lblPlan": "Operational Planning:",
        "llin.eyebrow": "04 — Prevention Tools & LLINs", "llin.title": "<span class=\"ln\"><span>Comparative matrix of</span></span><span class=\"ln\"><span>next-generation <span class=\"it\">mosquito nets</span></span></span>", "llin.lede": "Comparative analysis of long-lasting insecticidal nets (LLINs): modes of action, efficacy against multi-resistant vectors, and WHO prequalification status.", "llin.tabAll": "All Technologies", "llin.tabStd": "Standard", "llin.tabPbo": "PBO Synergist", "llin.tabG2": "Interceptor G2 (Chlorfenapyr)", "llin.tabRg": "Royal Guard (Pyriproxyfen)", "llin.lblMode": "🔬 Mode of action:", "llin.lblTarget": "🎯 Target resistance:", "llin.lblBenin": "🌍 Context & Deployment in Benin:", "llin.lblEff": "Field efficacy", "llin.lblDur": "Durability",
        "cost.eyebrow": "12 — Health Economics & Assessment", "cost.title": "<span class=\"ln\"><span>Cost-effectiveness simulator</span></span><span class=\"ln\"><span>of vector control <span class=\"it\">strategies</span></span></span>", "cost.lede": "Comparative modeling of cost per protected person and cost per malaria case averted to help national control programs and funders optimize resource allocation.", "cost.formTitle": "Health District Parameters", "cost.lblPop": "District target population:", "cost.hintPop": "E.g. 150,000 inhabitants", "cost.lblInc": "Baseline annual malaria incidence:", "cost.hintInc": "Cases per 1000 pop/year", "cost.lblIntervention": "Evaluated vector control strategy:", "cost.lblCov": "Effective population coverage rate:", "cost.covCovered": "of population covered", "cost.btnCalc": "Calculate Health-Economic Assessment", "cost.tagReport": "Economic Assessment & Health Impact", "cost.lblBudget": "Estimated Annual Budget", "cost.subBudget": "Total investment", "cost.lblCases": "Malaria Cases Averted", "cost.subCases": "Clinical cases prevented / year", "cost.lblCostCase": "Cost / Averted Case", "cost.subCostCase": "Cost-effectiveness ratio", "cost.lblSynth": "Decision Support Summary:",
        "glp.eyebrow": "13 — Quality Assurance & GLP", "glp.title": "<span class=\"ln\"><span>GLP self-assessment checklist</span></span><span class=\"ln\"><span>for insectaries &amp; <span class=\"it\">trial stations</span></span></span>", "glp.lede": "Interactive 10-point audit tool based on WHO and OECD guidelines to verify operational compliance of insectaries and bioassay procedures.", "glp.checklistTitle": "WHO Compliance Criteria (10 Pillars)", "glp.tagScore": "GLP Audit Score", "glp.critValidated": "criteria validated", "glp.lblDiag": "Operational Diagnosis:",
        "audio.eyebrow": "14 — Micro-Learning & Audio Outreach", "audio.title": "<span class=\"ln\"><span>Audio micro-capsules</span></span><span class=\"ln\"><span>\"3 Minutes of <span class=\"it\">Medical Entomology</span>\"</span></span>", "audio.lede": "Bite-sized episodes breaking down key concepts, insecticide innovations, and real-world vector control challenges in Africa.", "audio.playlistTitle": "Available Episodes (Educational Series)", "audio.byDr": "By Dr Idelphonse Ahogni, PhD", "audio.btnPlay": "▶ Listen to audio", "audio.transcriptTitle": "📝 Full lecture transcript:",
        "glossary.eyebrow": "09 — Terminology & Scientific Glossary", "glossary.title": "<span class=\"ln\"><span>Bilingual glossary of</span></span><span class=\"ln\"><span>medical entomology &amp; <span class=\"it\">public health</span></span></span>", "glossary.lede": "Rigorous definitions and operational concepts of vector control, insecticide resistance, and malaria epidemiology.", "glossary.searchPlaceholder": "Search term, acronym (e.g. EIR, kdr, PBO, bioassay)...", "glossary.empty": "No scientific terms match your search.",
        "ai.eyebrow": "08 — Scientific Knowledge Base & Research Engine", "ai.floatLabel": "Knowledge Base", "ai.widgetTitle": "Dr Ahogni · Knowledge Base", "ai.widgetStatus": "● Certified Semantic Engine · 0 ms · 100% Verified", "ai.title": "<span class=\"ln\"><span>Scientific research engine &amp;</span></span><span class=\"ln\"><span>expert <span class=\"it\">knowledge base</span></span></span>", "ai.lede": "Query Dr Ahogni's scientific knowledge base directly on WHO protocols, field trial findings, genetic resistance mechanisms, and vector control strategies.", "ai.welcomeMsg": "<p><strong>Welcome to Dr Idelphonse Ahogni's Knowledge Base.</strong></p><p style=\"margin-top:6px;font-size:0.88rem;color:var(--ink2);\">Instant semantic search across 25+ publications, WHO protocols, vector genetics (<em>kdr/ace-1</em>), LLINs, field data, and health-economic tools.</p>", "ai.quickLabel": "Frequently Asked Questions & Suggestions:", "ai.inputPlaceholder": "E.g. Interceptor G2, Abbott, kdr, Covè, Fleiss, GLP...", "ai.btnSubmit": "Search →",
        "mentorship.eyebrow": "10 — Mentorship & Academic Training", "mentorship.title": "<span class=\"ln\"><span>Academic mentorship</span></span><span class=\"ln\"><span>&amp; network of <span class=\"it\">trained scientists</span></span></span>", "mentorship.lede": "Research supervision, PhD dissertation co-direction, and Master's theses mentoring in medical entomology and public health.", "mentor.lblTopic": "Research topic:", "mentor.lblCurrent": "Current position & outcome:",
        "timeline.eyebrow": "04 — Grants & Operational Research", "timeline.title": "<span class=\"ln\"><span>Research programs</span></span><span class=\"ln\"><span>&amp; funded <span class=\"it\">grants</span></span></span>", "timeline.lede": "Translational research and operational evaluation programs conducted alongside global funding agencies and health ministries.", "timeline.filterAll": "All programs", "timeline.lblRole": "Role:", "timeline.lblDeliv": "Deliverables & Key Impacts:",
        "malariawatch.eyebrow": "08 — Epidemiological Surveillance & Alerts", "malariawatch.title": "<span class=\"ln\"><span>Transmission bulletins</span></span><span class=\"ln\"><span>&amp; entomological <span class=\"it\">watch</span></span></span>", "malariawatch.lede": "Regular briefs on spatiotemporal malaria transmission dynamics, regional vector alerts, and public health guidelines.", "malariawatch.lblAction": "Action Points & Recommendations:",
        ...
        "academic.eyebrow": "07 — Resources & Training Hub", "academic.title": "<span class=\"ln\"><span>Academic resources center</span></span><span class=\"ln\"><span>&amp; laboratory <span class=\"it\">protocols</span></span></span>", "academic.lede": "Standard operating procedures (WHO/GLP SOPs), methodological guidelines, and training materials for students, researchers, and health technicians.", "academic.filterAll": "All documents", "academic.filterProto": "Protocols", "academic.filterCourse": "Course materials", "academic.filterGuide": "Field guides", "academic.filterSheet": "Technical sheets", "academic.consult": "View", "academic.download": "Download",
        "speaker.eyebrow": "Academic Engagement & Keynotes", "speaker.title": "<span class=\"ln\"><span>Invite to a conference</span></span><span class=\"ln\"><span>or <span class=\"it\">request expertise</span></span></span>", "speaker.lede": "Guided form for organizing committees, universities, public health agencies, and global research consortia.", "speaker.step1": "Format", "speaker.step2": "Topic", "speaker.step3": "Logistics", "speaker.step4": "Review", "speaker.titleStep1": "What type of event are you organizing?", "speaker.fmt1Title": "Keynote / Plenary Lecture", "speaker.fmt1Desc": "Keynote address at scientific congresses or international symposia (30-45 min).", "speaker.fmt2Title": "Panel / Round Table", "speaker.fmt2Desc": "Expert panel on public health policies and vector control.", "speaker.fmt3Title": "Workshop / Masterclass", "speaker.fmt3Desc": "Hands-on training on bioassay SOPs and entomological surveillance (half or full day).", "speaker.fmt4Title": "Consulting & Evaluation", "speaker.fmt4Desc": "Program evaluation missions, entomological audits, or grant proposal reviews.", "speaker.btnNext": "Continue →", "speaker.btnPrev": "← Previous", "speaker.titleStep2": "Select target thematic axes:", "speaker.top1Title": "Insecticide Resistance & LLINs", "speaker.top1Desc": "Evolution of kdr/ace-1 alleles and impact on prevention tools.", "speaker.top2Title": "Genomic Surveillance", "speaker.top2Desc": "High-throughput sequencing, phylogeography and resistance gene flow tracking.", "speaker.top3Title": "Experimental Huts & Phase II Trials", "speaker.top3Desc": "Semi-field evaluation protocols under standard WHO guidelines.", "speaker.top4Title": "Emerging Vectors (An. stephensi)", "speaker.top4Desc": "Urban malaria threats, molecular diagnostics and early warning systems.", "speaker.lblCustomTopic": "Other topic or exact session title:", "speaker.phCustomTopic": "E.g. Role of early-career scientists in malaria elimination by 2030", "speaker.titleStep3": "Event logistical details:", "speaker.lblEventDate": "Proposed date or time frame:", "speaker.phEventDate": "E.g. November 2026 / March 15-18, 2027", "speaker.lblEventLocation": "Location / City (or Virtual):", "speaker.phEventLocation": "E.g. Cotonou, Geneva, London or Videoconference", "speaker.lblAudienceSize": "Audience size and profile:", "speaker.lblEventLang": "Language of delivery:", "speaker.btnSummary": "Summary →", "speaker.titleStep4": "Your contact info for confirmation:", "speaker.lblOrgName": "Full name:", "speaker.phOrgName": "Dr / Prof ...", "speaker.lblOrgEmail": "Work email address:", "speaker.phOrgEmail": "contact@institution.org", "speaker.lblOrgEntity": "Organizing institution / University / Agency:", "speaker.phOrgEntity": "E.g. WHO AFRO, PAMCA, London School...", "speaker.summaryTitle": "📋 Summary of your request:", "speaker.btnEdit": "← Edit", "speaker.btnSend": "🚀 Submit Official Request", "speaker.successTitle": "Keynote request prepared successfully!", "speaker.successDesc": "A preformatted message with full logistics and topics has been generated. You can also directly book a 20-minute introductory call:", "speaker.btnAgenda": "📅 Book a 20-min direct call", "speaker.btnMail": "✉️ Send by email",
        "pubs.eyebrow": "05 — Publications", "pubs.title": "<span class=\"ln\"><span>All peer-reviewed</span></span><span class=\"ln\"><span><span class=\"it\">publications</span></span></span>", "pubs.intro": "More than 25 publications in premier international journals in the field — Malaria Journal, Parasites & Vectors, Acta Tropica, PLOS ONE, and others. Complete list organized by year, with filters, search, and citation tools.", "pubs.searchPlaceholder": "Search by title, author, journal, year...", "pubs.expBib": "Export all (.bib)", "pubs.expRis": "Export all (.ris)", "pubs.filterAll": "All", "pubs.viewPdf": "View PDF 👁", "pubs.cite": "Cite / Citation ▾", "pubs.prev": "← Prev", "pubs.next": "Next →", "pubs.empty": "No publications matched your search criteria.", "pubs.profiles": "Full scientific profiles:", "pubs.modalTitle": "Cite this publication", "pubs.copyBtn": "Copy citation",
        "cv.eyebrow": "07 — Curriculum Vitæ", "cv.title": "<span class=\"ln\"><span>Full career path,</span></span><span class=\"ln\"><span><span class=\"it\">training &amp; expertise</span></span></span>", "cv.intro": "Malaria program manager, medical entomologist — education, career trajectory, core competencies, and selected publications.", "cv.modeFull": "Detailed View", "cv.modeSummary": "Executive Summary (1-Page)", "cv.btnPdf": "⬇ Download PDF", "cv.docEyebrow": "Curriculum Vitæ · Republic of Benin", "cv.secHighlights": "Highlights & Key Impact", "cv.stat1": "Years field experience", "cv.stat2": "International publications", "cv.stat3": "Target countries in Africa", "cv.stat4": "Clinical trials & LLINs", "cv.sec01": "Profile & Professional Summary", "cv.sec02": "Core Competencies", "cv.sec03": "Professional Experience", "cv.sec04": "Education & Degrees", "cv.sec05": "Technical Skills & Methods", "cv.sec06": "Selected Publications",
        "speaking.eyebrow": "Communications", "speaking.title": "<span class=\"ln\"><span>Conferences &amp;</span></span><span class=\"ln\"><span><span class=\"it\">presentations</span></span></span>", "speaking.intro": "Scientific talks, communications at international congresses and symposia on vector control and public health.", "speaking.filterAll": "All", "speaking.empty": "No communications matched the selected filter.",
        "blog.eyebrow": "10 — Blog · Field Notes", "blog.title": "<span class=\"ln\"><span>Field</span></span><span class=\"ln\"><span><span class=\"it\">notes</span> &amp; reflections</span></span>", "blog.intro": "Field chronicles, teaching notes, and updates on vector control and malaria research.", "blog.filterAll": "All", "blog.readNote": "Read note →", "blog.empty": "No field notes published yet. Please check back soon.", "blog.backAll": "← All field notes", "blog.tocTitle": "Table of Contents", "blog.otherNotes": "Other field notes", "blog.shareLabel": "Share this article:",
        "contact.eyebrow": "Contact Dr Idelphonse B. AHOGNI", "contact.title": "<span class=\"ln\"><span>Let's work <span class=\"it\">together</span> against</span></span><span class=\"ln\"><span>malaria.</span></span>", "contact.avail": "<span class=\"dot\"></span> Available — response within 48 business hours", "contact.formTitle": "Send a message", "contact.formSub": "Fields marked <b style=\"color:var(--coral)\">*</b> are required. Your message will be securely transmitted with a response within 48 business hours.", "contact.lblName": "Full name", "contact.phName": "Dr Awa Diallo", "contact.errName": "Please enter your name.", "contact.lblEmail": "Email address", "contact.phEmail": "you@institution.org", "contact.errEmail": "Invalid email address.", "contact.lblOrg": "Organization", "contact.phOrg": "Ministry, NGO, university…", "contact.lblSubject": "Subject of request", "contact.lblMsg": "Message", "contact.phMsg": "Describe your inquiry: context, timeline, countries involved…", "contact.errMsg": "Please elaborate your message (min 20 characters).", "contact.btnSend": "Send message ↗", "contact.kCard": "Digital Contact Card", "contact.btnVcf": "Save contact card (.vcf)", "contact.vcfSub": "Compatible with iPhone, Android, Outlook & Address Book", "contact.kEmail": "Email", "contact.emailSub": "Preferred channel — attachments welcome", "contact.kPhone": "Phone / WhatsApp", "contact.phoneSub": "Mon – Fri · 8am – 6pm GMT+1", "contact.kClock": "Local time in Cotonou", "contact.kLang": "Languages & networks", "contact.vLang": "French & Fon (native) · English (scientific)", "contact.faqTitle": "Frequently Asked Questions", "contact.qrDesc": "Scan this code with your smartphone camera to save <b>Dr Idelphonse AHOGNI</b> directly to your contacts.", "contact.qrDl": "Direct .vcf Download",
        "pres.exit": "← Exit Presentation", "pres.fullscreen": "⛶ Fullscreen", "pres.prev": "← Previous", "pres.next": "Next →",
