  ...
  (function langSwitch() {
    const dict = {
      ...
      en: {
        ...
        "genetics.eyebrow": "06 — Population Genetics & Markers", "genetics.title": "<span class=\"ln\"><span>Allele frequency calculator</span></span><span class=\"ln\"><span>&amp; <span class=\"it\">Hardy-Weinberg (HWE)</span> test</span></span>", "genetics.lede": "Interactive population genetics tool analyzing resistance markers <em>kdr</em> (L1014F/S) and <em>ace-1</em> (G119S) dynamics in Anopheles vectors.", "genetics.formTitle": "Entomological Sample Parameters",
        "size.eyebrow": "07 — Methodology & Biostatistics", "size.title": "<span class=\"ln\"><span>Sample size calculator</span></span><span class=\"ln\"><span>&amp; study power <span class=\"it\">(WHO Bioassays)</span></span></span>", "size.lede": "Biometric tool to plan required mosquito sample sizes for bioassay protocols, WHO cone tests, and residual efficacy monitoring in experimental huts.", "size.formTitle": "Comparative Study Parameters",
        "llin.eyebrow": "04 — Prevention Tools & LLINs", "llin.title": "<span class=\"ln\"><span>Comparative matrix of</span></span><span class=\"ln\"><span>next-generation <span class=\"it\">bed nets</span></span></span>", "llin.lede": "Comparative analysis of long-lasting insecticidal nets (LLINs): modes of action, efficacy against multi-resistant Anopheles, and WHO prequalification status.", "llin.tabAll": "All technologies", "llin.tabStd": "Standards", "llin.tabPbo": "PBO Synergists", "llin.tabG2": "Interceptor G2 (Chlorfenapyr)", "llin.tabRg": "Royal Guard (Pyriproxyfen)",
